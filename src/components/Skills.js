...
export default function Skills() {
  return (
    <section id="skills" className="relative" style={{ backgroundImage: "url('./background-about.jpg')" }}>
      <div className="absolute inset-0 bg-black opacity-70"></div> {/* Overlay Gelap */}
      <div className="container px-5 py-10 mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">Technical and soft skills that I have.</p>
        </div>
