      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            Fresh graduate in Computer Engineering seeking a challenging role as a machine learning engineer, data analyst, and data science. Experienced in developing machine learning models with Natural Language Processing and Computer
            Vision in Internship and Undergraduate Thesis Project.{" "}
          </p>
